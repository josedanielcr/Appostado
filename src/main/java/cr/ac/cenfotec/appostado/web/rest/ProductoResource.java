...
/**
 * REST controller for managing {@link cr.ac.cenfotec.appostado.domain.Producto}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Producto> partialUpdateProducto(
        ...
        Optional<Producto> result = productoRepository
            ...
            .map(existingProducto -> {
                ...
                if (producto.getCodigoFijo() != null) {
                    existingProducto.setCodigoFijo(producto.getCodigoFijo());
                }
                if (producto.getNumCompras() != null) {
                    existingProducto.setNumCompras(producto.getNumCompras());
                }
