package cr.ac.cenfotec.appostado.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, cr.ac.cenfotec.appostado.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, cr.ac.cenfotec.appostado.repository.UserRepository.USERS_BY_EMAIL_CACHE);
